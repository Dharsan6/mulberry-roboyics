...
const detailToSteps = (detail: 'low' | 'medium' | 'high'): number => {
...
const ctxMap = new WeakMap<HTMLElement, ContextData>();
...
export const GradientWaves: React.FC<GradientWavesProps> = ({
  ...
  return <div ref={containerRef} style={style} className={`gradient-waves-container ${className}`.trim()} />;
};
